...
CREATE TABLE `companies` (
  ...
  `preface_en` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `preface_ar` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `web_site_url` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
