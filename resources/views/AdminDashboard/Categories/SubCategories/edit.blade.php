...
@section('content')
    ...
    <form method="post" action="{{route('SubCategory.update',$SubCategory)}}" class="" enctype="multipart/form-data">
      {{  csrf_field()}}
      {{  method_field('put')}}
        ...
        @endif
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" name="name" placeholder="" value="{{$SubCategory->name}}">
            </div>
            <?php
            ...
            <div class="form-group ml-3">
                ...
                <label for="user_image" class="form-label">
                    <img style="width:200px;height:200px;" src="{{asset('assets/dist/img/SubCategory-images/'.$SubCategory->image)}}" class="img-thumbnail image-preview">
                </label>
